            ...
            <div
                ...
                <div class="relative z-10 mx-auto max-w-md">
                    ...
                    <div
                        ...
                        <h1 class="text-md font-semibold leading-7 text-sky-500 dark:text-white sm:text-3xl sm:truncate">
                            Program Beasiswa</h1>
                    </div>
                    <div
                        ...
                        <p>Yayasan Kuliah Asik memberikan beasiswa kepada calon mahasiswa Universitas KA melalui Bebas Uang
                            Kuliah
                        </p>
                    </div>
                </div>
        ...
        <a href="{{route('pendaftaran.create', ['jalur' => 'Test'])}}" type="button">
            <div
                ...
                <div class="relative z-10 mx-auto max-w-md">
                    ...
                    <div
                        class="space-y-6 pt-5 text-base leading-7 text-gray-500 dark:text-white transition-all duration-300 group-hover:text-white/90">
                        <p>Universitas KA memiliki beberapa jalur seleksi, salah satunya adalah Ujian Tulis Mandiri Berbasis
                            Komputer.</p>
                    </div>
                ...
                <div class="relative z-10 mx-auto max-w-md">
                    <span
                        ...
                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            style="enable-background:new 0 0 96.17 122.88" xml:space="preserve"class="w-10 h-10 fill-white">
                            <g>
                                <path
                    ...
                    <div
                        class="space-y-6 pt-5 text-base leading-7 text-gray-200 transition-all duration-300 group-hover:text-white/90">
                        <h1 class="text-xl font-semibold leading-7 text-yellow-500 dark:text-white sm:text-xl sm:truncate">
